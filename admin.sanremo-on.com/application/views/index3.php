...
<head>
	<meta charset="UTF-8">
	<title>Sanremo On | Admin Microsite</title>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<img src="<?php
								echo (file_exists('public/uploads/'.$usuario->getFoto()) === FALSE ) ? base_url().'public/images/user.png' : base_url().'public/uploads/'.$usuario->getFoto() 
		...
		<span class="input-group-btn">
			<button type='submit' name='search' id='search-btn' class="btn btn-flat"><i class="fa fa-search"></i></button>
				...
				<ul class="sidebar-menu" ng-controller="menuController as menu">
					...
					<li>
						<a href="" >
							<i class="fa fa-dashboard" ></i><span>Benvenuto</span>
						</a>
					</li>
					<li>
						<a href="<?php echo base_url().'admin/microsite_micro' ?>" data-type="ajax" data-load="principal">
							<i class="fa fa-map-marker"></i> <span>Microsites</span>
						</a>
					</li>
					<li>
						<a href="<?php echo base_url().'ofer/index_micro' ?>" data-type="ajax" data-load="principal">
							<i class="fa fa-tags"></i> <span>Offerte</span>
						</a>
					</li>
					<li>
						<a href="<?php echo base_url().'not/index_micro' ?>" data-type="ajax" data-load="principal">
							<i class="fa fa-newspaper-o"></i> <span>Notizie</span>
						</a>
					</li>
					<!-- <li>
						<a href="<?php echo base_url().'evt/index_micro' ?>" data-type="ajax" data-load="principal">
							<i class="fa fa-newspaper-o"></i> <span>Eventi</span>
						</a>
					</li> -->
					<li>
						<a href="<?php echo base_url().'admin/micro_perfil/'.$usuario->getIduser() ?>" data-type="ajax" data-load="principal">
							<i class="fa fa-users"></i> <span>Configurazione</span>
						</a>
					</li>
		...
		<div class="content-wrapper">
			...
			<section class="content" >
				<div class="mainSection">
					<img src="<?php echo base_url() ?>public/images/Back-User.png" alt="" style="width: 100%;">
				</div>
			</section>
			<!-- right col -->
		</div>
