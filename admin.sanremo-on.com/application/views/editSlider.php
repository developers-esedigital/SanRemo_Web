...
<div class="register-box">
	<div class="register-box-body" ng-controller="DatepickerDemoCtrl">
		<p class="login-box-msg">Modifica Slider</p>
		<form action="<?php echo base_url() ?>slid/add" method="post" enctype="multipart/form-data" id="registerCategoria">
			<input type="hidden" name="idslider" value="<?php echo $slider->getIdslider() ?>">
			...
			<div class="input-group">
		      <span class="input-group-addon">
		        <input type="checkbox" aria-label="" value="activado" name="estatusSlider" <?php echo $slider->getEstatus() == 1 ? 'checked' : '' ?>>Estatus
