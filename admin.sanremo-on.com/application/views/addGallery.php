...
<div class="register-box">
	<div class="register-box-body" ng-controller="DatepickerDemoCtrl">
		<p class="login-box-msg">Nuovo Gallery</p>
		<form action="<?php echo base_url() ?>index.php/gall/add" method="post" enctype="multipart/form-data" id="registerCategoria">
			<input type="hidden" name="registro" value="1">
			<div class="form-group has-feedback">
				<label for="exampleInputEmail1">Seleziona l'immagine principale per la Gallery</label>
			...
			<div class="input-group">
		      <span class="input-group-addon">
		        <input type="checkbox" aria-label="" value="activado" name="estatusSlider">Attivato
