...
<div class="register-box">
	<div class="register-box-body" ng-controller="DatepickerDemoCtrl">
		<p class="login-box-msg">Nuova Notizia</p>
		<form action="<?php echo $post ?>" method="post" enctype="multipart/form-data" id="registerOferta">
			...
			<div class="form-group has-feedback">
				...
				<?php else: ?>
				<select name="idmicrosite" data-chosen="1" data-placeholder="Seleziona Microsite" id="" class="form-control">
					<option value=""></option>
		...
		<div class="form-group has-feedback">
			<label for="exampleInputEmail1">Seleziona l'immagine principale per la notizia (1876*780)</label>
		...
		<div class="form-group has-feedback">
			<?php foreach ($config->idiomas as $key => $value): ?>
				<div class="input-group">
					...
					<span class="input-group-addon" id="basic-addon">http://www.sanremo-on.com/<?php echo $value->letras ?>/news/attualita/<span class="uu"><?php echo isset($no) ? clearStr(strtolower($ttt->it)) : '' ?></span>/</span>
