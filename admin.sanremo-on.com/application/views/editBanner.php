...
<div class="register-box">
	<div class="register-box-body" ng-controller="DatepickerDemoCtrl">
		<p class="login-box-msg">Modifica Banner</p>
		<form action="<?php echo base_url() ?>index.php/ban/add" method="post" enctype="multipart/form-data" id="registerCategoria">
			<input type="hidden" name="idbanner" value="<?php echo $banner->getIdbanner() ?>">
			...
			<div class="form-group">
				<label for="exampleInputEmail1">Seleziona l'url</label>
				<input type="text" value="<?php echo $banner->getUrl() ?>" class="form-control" placeholder="Url" name="url" required/>
				<span class="glyphicon glyphicon-log-in form-control-feedback"></span>
			</div>
			<div class="input-group">
		      <span class="input-group-addon">
		        <input type="checkbox" aria-label="" value="activado" name="estatusBanner" <?php echo $banner->getEstatus() == 1 ? 'checked' : '' ?>>Estatus
...
$('input[name="principal"]').fileinput({
    ...
    minFileCount: 1,
    initialPreview: [
        "<img src='<?php echo base_url() ?>public/uploads/banners/<?php echo $banner->getImgnormal()?>' class='file-preview-image'>"
    ],
	allowedFileExtensions: ['jpg', 'png', 'gif'],
    elErrorContainer: "#errorBlock43",
	previewFileIcon: "<i class='glyphicon glyphicon-king'></i>"
});
$('input[name="movil"]').fileinput({
	showUpload: false,
	browseClass: "btn btn-primary",
	language: 'es',
	uploadAsync: false,
	initialPreview: [
        "<img src='<?php echo base_url() ?>public/uploads/banners/<?php echo $banner->getImgmovil()?>' class='file-preview-image'>"
    ],
    minFileCount: 1,
	allowedFileExtensions: ['jpg', 'png', 'gif'],
    elErrorContainer: "#errorBlock43",
