...
class Oferta
{
     ...
     * @var string
     *
     * @ORM\Column(name="gridmovil", type="string", length=1000, nullable=true)
     */
...
/**
     * @var integer
     *
     * @ORM\Column(name="isimmobiliare", type="integer", nullable=false)
     */
    private $isimmobiliare;
    /**
     * Get idoferta
     *
     * @return integer 
    ...
    public function setGridmovil($imagengrid)
    {
        $this->gridmovil = $imagengrid;
     ...
     * @return string 
     */
    public function getGridmovil()
    {
        return $this->gridmovil;
    }
     ...
     * Set isimmobiliare
     *
     * @param intiger $isimmobiliare
     * @return intiger
     */
    public function setIsImmobiliare($isimmobiliare){
        $this->isimmobiliare = $isimmobiliare;
        return $this;
    }
     ...
     * @return integer 
     */
    public function getIsImmobiliare()
    {
        return $this->isimmobiliare;
    }
}
