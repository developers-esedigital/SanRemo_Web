...
<html lang="it">
	<head>
		...
		<link rel="canonical" href="http://sanremo-on.com/it/microsite.html" />
					...
					<div class="cuerpo">
						...
						<div class="row resultados">
							...
							<div class="row imagen hidden-xs">
								<div id="pre-load" class="spinner"></div>
							...
							<div class="row imagen visible-xs">
								<div id="pre-loadres" class="spinner"></div>
								...
								<!-- <img id="loguis" class="logo-img-res visible-xs" alt="" data-field="logoRes" style="z-index:-1"  src=""> -->
							</div>
...
<div class="izquierda pull-left">
	...
	<a href="" class="botonNegro2" style="display:none" target="_blank" data-field="instagram">
		<i class="fa fa-instagram negro pull-left social-i"></i>
						...
						<div class="row linea orange eventos">
							<strong>EVENTI</strong>
							<div class="raya"></div>
						</div>
						<div class="row offerandnew resultados eventos">
