				...
				<div class="content">
					<div class="cuerpo">
						<div class="row hidden-xs">
							<ol class="breadcrumb">
								<li><a href="/">Home</a></li>
								<li><a href="http://sanremo-on.com/it/news.html">News</a></li>
						...
						<div class="row cuerpo2">
							<div class="col-sm-12">
							<span class="orange titulo-secundario"><strong data-field="nombre">SUBTITULO OFFERTA</strong><span style="margin-left:70px;" class="orange percentual-dentro" data-field="oferta"></span></span>
