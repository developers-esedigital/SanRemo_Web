...
<html lang="it">
	<head>
		...
		<link href="http://sanremo-on.com/pruebaf/css/bootstrap-select.css" rel="stylesheet">
		...
		<link rel="stylesheet" href="http://sanremo-on.com/pruebaf/css/css.eventi.css">
	...
	<body>
					...
					<div class="cuerpo">
						...
						<div class="row cuerpo2">
							...
							<span class="orange titulo-secundario"><strong data-field="nombre">SUBTITULO EVENTO</strong></span>
								...
								<p class="text-justify margen-sobre cuerpo-de-texto" id="#dir">
									dir
								</p>
		...
		<script src="http://sanremo-on.com/pruebaf/js/jquery-1.11.2.min.js"></script>
		...
		<script src="http://sanremo-on.com/pruebaf/js/js.evento.js"></script>
