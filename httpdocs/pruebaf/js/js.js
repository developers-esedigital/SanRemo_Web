...
Tools.cargarPrincipal({
	...
	callback : function(data, textStatus, xhr){
		...
		var qq = '<img src="%src%" style="margin-left:0px; margin-right: 0px;" class="img-responsive" width="455px" height="100%"/>';
		var a = '</a>';
		var vid = '</div>'
		var link='';

		var templateGaleria = '<div class="item" style="width:100%;max-height: 390px; overflow:hidden;">%pp%</div>';

		var templateGaleria1 = '<div class="item active" style="width:100%;max-height: 390px; overflow:hidden;">%pp%</div>';
