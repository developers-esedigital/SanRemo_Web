...
var bot = '<div class="col-sm-4" style="margin-left: 42px;"></div><div id="boton" class="col-sm-2" style="background: #C9840D none repeat scroll 0px 0px; color: #FFF;font-size: 11px;margin-bottom: 25px;margin-top: 25px;padding: 20px 30px;text-transform: uppercase;width: 215px;text-align: center;cursor: pointer;">'+it+'</div>';
