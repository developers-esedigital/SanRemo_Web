...
var etiquetasLogin = {
	...
	ru:{
		'tituloLogin':'Пожалуйста войдите в ваши электроэнергии',
		'contenidoLogin':'Ваша конфиденциальность имеет первостепенное значение для нас: мы никогда не дают ни продавать ваши личные данные третьим лицам'
	}
};
