						...
						<div class="row mensaje mensaje-prenota mensaje-blu acodation" style="display:none">
								...
								<div>
									<a  data-field="prenota"  title="" href="#" target="_blank" class="dropdown cambio" title="Registro">
										...
										<div class="col-sm-7">
											<div>
												<p class="text-justify blu">Хотите забронировать ваш отпуск в Санремо? Кликните, чтобы узнать возможности, тарифы и
                                                    предложения отелей, резиденций, а так же кинотеатров и театров города цветов.</p>
										...
										<div class="col-sm-4">
											<div>
												<div class="buttonBlue">БРОНИРУЙ НЕМЕДЛЕННО</div>
											</div>
										</div>
										<div class="clearfix"></div>
									</a>
									...
									<a  data-field="prenota"  title="" href="#" target="_blank" class="dropdown cambio" title="Registro">
										...
										<div class="col-sm-7">
											<div>
												...
												Хотите забронировать ваш отпуск в Санремо? Кликните, чтобы узнать возможности, тарифы и предложения отелей, резиденций, а так же кинотеатров и театров города цветов.</p>
											</div>
											<div class="clearfix"></div>
										</div>
										<div class="col-sm-4">
