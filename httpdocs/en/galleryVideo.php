...
?> 
		...
		<html lang="en">
			<head>
				...
				<link rel="canonical" href="http://www.sanremo-on.com/en/galleryVideo.php">
					<!-- ICONOS -->
			...
			<div id="header-container" class="Fixed">
								...
								<div class="content">
									<div class="cuerpo">
										...
										<div class="row filtros">
											<div class="col-sm-2">
												<span class="orange"><strong>Gallery-Video</strong></span>
											</div>
										</div>
										<br>
											...
											<ul class="bxslider">
																							  <li class="">
												         								<iframe src="https://www.youtube.com/embed/4vTgFhvSbHw" webkitAllowFullScreen mozallowfullscreen allowFullScreen frameborder="0" width="560" height="315"></iframe>
																									</li>
																							<li class="">
																							<iframe src="https://www.youtube.com/embed/rwX28vVId9o" webkitAllowFullScreen mozallowfullscreen allowFullScreen frameborder="0" width="560" height="315"></iframe>
																							</li>

																							<li class="">
																							 <iframe src="https://www.youtube.com/embed/EujB7kbZ4As" webkitAllowFullScreen mozallowfullscreen allowFullScreen frameborder="0" width="560" height="315"></iframe>
																							</li>

																							<li class="">
																							 <iframe src="https://www.youtube.com/embed/0Sf0hfUKtqQ" webkitAllowFullScreen mozallowfullscreen allowFullScreen frameborder="0" width="560" height="315"></iframe>
																							</li>
																							<li class="">
																							 <iframe src="https://www.youtube.com/embed/OzBfKpf7uY8"webkitAllowFullScreen mozallowfullscreen allowFullScreen frameborder="0" width="560" height="315"></iframe>
																							</li>
										...
										<div class="row mensaje">
												...
												<div>
													<a data-target="#panel-mailchimp" data-toggle="modal" title="" href="#" data-original-title="Login" class="dropdown cambio" title="Registro">
														...
														<div class="col-sm-3" style="margin-left:6%; display: block !important;">
															<div>
													...
													<div class="row segundo">
														...
														<div class="social col-sm-5">
															<div class="col-sm-12">
																		...
																		<img class="col-sm-5" src="/images/sr-icon-app.png" alt="" style="border-radius: 10px !important; padding:0px !important;width: 80px;"><div style="width: 90px;float: right;transform:translate(-50px);" class="col-sm-5"><a href="https://itunes.apple.com/it/app/sanremo-on/id1031320757?mt=8" target="_blank"><img src="http://sanremo-on.com/images/AppleStorelogoOn@2.png" alt="" width="87" height="33" style="left: -20px;"></a><a href="https://play.google.com/store/apps/details?id=com.ionicframework.myapp802908" target="_blank"><img src="http://sanremo-on.com/images/Playstorelogowhite@2.png" alt="" width="87" height="33"></a></div>
				...
				<script src="/js/js.attualita.js"></script>
