		...
		<div id="header-container" class="Fixed">
				    ...
				    width: 100%;">
				                                    ...
				                                    <li id="sanmenunegozi" class="offers" style="    padding-top: 17px;">
														...
														<li>
															<a class="sananegozi" title="" href="http://sanremo-on.com/ru/news/offerte-immobiliari.html"><span>предложения недвижимости</span></a>
														</li>
													</ul>
				                                    </li>
					...
					<div class="cuerpo">
						<div class="row hidden-xs">
							<ol class="breadcrumb">
								...
								<li><a href="/ru/news.html">�?ово�?ти</a></li>
