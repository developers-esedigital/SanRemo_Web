...
//console.log("paquete> "+item.paquete);
//console.log("isimmobiliare> "+item.isimmobiliare);
            if (item.isimmobiliare == 1) {
//console.log("this is testing");
        ...
        $("#boton").click(function() {
            ...
            for (var i = 0; i < rr.length; i++) {
                var item = rr[i];
                if (item.paquete == 1 && item.isimmobiliare == 1) {
