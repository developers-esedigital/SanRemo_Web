...
$result=mysql_query("select count(*) from noticia where estatus=1 and enviado=0");
...
mysql_query("update noticia set enviado=1 where estatus=1");
$result=mysql_query("select count(*) from evento where estatus=1 and enviado=0");
$row = mysql_fetch_row($result);
if ($row[0]>0) {
...
mysql_query("update evento set enviado=1 where estatus=1");
$result=mysql_query("select oferta.idoferta as idz, microsite.nombre as mnom from oferta inner join microsite on (oferta.idmicrosite=microsite.idmicrosite) where oferta.estatus=1 and oferta.enviado=0");
...
mysql_query("update oferta set enviado=1 where estatus=1");
